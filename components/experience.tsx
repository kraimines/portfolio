  ...
  const experiences = [
    {
      ...
      description:
        'Built role-aware dashboards on a Neo4j/PostgreSQL model; developed a LangGraph conversational assistant orchestrating HR/CRM/ERP systems with RAG-based retrieval and automated workflows; delivered a market-intelligence pipeline.',
      achievements: ['Best FYP Project ranked by PwC'],
      technologies: ['Python', 'LangGraph', 'Neo4j', 'PostgreSQL', 'RAG', 'Power BI'],
